...
class EventForm(FlaskForm):
    ...
    short_description = TextAreaField('Short Description', validators=[InputRequired('Please enter a brief event description'), Length(max=255, message='Must be less than 255 characters long')])
