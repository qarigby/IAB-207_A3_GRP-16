...
class EventForm(FlaskForm):
    ...
    genre = StringField('Genre', validators=[InputRequired('Please enter a genre')])
    ...
    short_description = StringField('Short Description', validators=[InputRequired('Please enter a short description'), Length(max=255, message="Must be less than 255 characters long")])
